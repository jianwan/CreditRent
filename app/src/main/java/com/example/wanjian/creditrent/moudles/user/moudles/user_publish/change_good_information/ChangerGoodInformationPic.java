...
import com.example.wanjian.creditrent.moudles.homepage.UploadGoodsOkActivity;
...
public class ChangerGoodInformationPic extends BaseActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.uploadgoodsPic_iv_tv:
                new AlertDialog.Builder(ChangerGoodInformationPic.this).setItems(new String[]{"照相机", "相册", "取消"}, new DialogInterface.OnClickListener() {
                    @Override
